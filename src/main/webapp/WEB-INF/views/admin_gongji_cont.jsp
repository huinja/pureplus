					...
					<div class="tab-pane active" id="home">
						<div class="table-responsive">
							<table class="table table-hover">
								...
								<div id="aMain_cont">
 <div id="aBc_wrap">
  <h2 class="aBc_title" style="color:#379bff;" align="center">관리자 공지 내용</h2>
  <table id="aBc_t" border="2px double" border-radius="50%" style="margin-top:70";>
 <!-- <h4 style="color:gray" align="center">${fn:substring(g.gongji_date,0,10)}</h4> -->
   <tr>
   ...
   <tr>
    <th>&nbsp;등록날짜</th> <td>${g.gongji_date}</td>
   </tr>
  </table>
  <div id="aBc_menu">
  <input type="button" style="border:none; border-radius:5px; margin-top:140;  background: #ff9900; color:white; font-family:fantasy ; "  value="목록"
