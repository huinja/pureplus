...
<div class="navbar">
	...
	<ul>
		...
		<li><a class="aa" href="pure_gongji_list">Common공지</a></li>
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<ul class="nav nav-tabs" id="myTab">
					<li class="active"><a href="#home" data-toggle="tab">Pure Plus+</a></li>
				</ul>
												...
												<c:if test="${!empty glist}">
													<c:forEach var="g" items="${glist}">
														<tr>
															...
															<td><a
																href="gongji_cont?gongji_no=${g.gongji_no}&page=${page}&state=cont">
