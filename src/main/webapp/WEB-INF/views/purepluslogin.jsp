...
<link rel="stylesheet" type="text/css" href="../project/projectlogin.css">
<body>
   <div class="container">
      <div class="col-md-6 mx-auto text-center">
         <div class="header-title">
         <a href="http://localhost:8051/pureplusseb"  style="text-decoration:none">
            ...
            <div class="myform form ">
               <form action="" method="post" name="login">
                  ...
                  <div class="form-group">
                     ...
                     <a class="btn btn-block g-button" href="http://localhost:7992/Html_Css/project/projectlogin2.jsp">
