...
<body>
  ...
  <div id="aMd_wrap">
   <h2 class="aMd_title"  style="color:#379bff; font-family: fantasy;" align="center">관리자 회원정보 수정</h2>
   ...
   action="admin_member_edit" onsubmit="return edit_check();">
    ...
    <table id="aMd_t" >
     <tr>
      ...
      <td><input name="id" size="14" value="${r.id}"
      readonly /></td>
     </tr>
     <tr>
      ...
      size="14" /></td>
         ...
         <tr>
   <th class="left_box">이름</th>
   <td><input name="name" size="14" value="${r.name}"
      /></td>
   </tr>
     <tr>
      <th class="left_box">폰번호</th>
      <td>
       </select><input name="phonenum" id="phonenum"
       size="20" maxlength="20" value="${r.phonenum}" />
      </td>
     </tr>
     <tr>
      <th class="left_box">전자우편</th>
      <td>
      <input name="mail" id="mail" size="30"
      value="${r.mail}" />
      </td>
     </tr>
     <tr>
      <th class="left_box">가입(1)/탈퇴(2)</th>
      <td><input name="r_state" size="2" 
      value="${r.r_state}" /></td>
     </tr>
     ...
     <tr>
      ...
      <th colspan="2">
      <input type="submit"style="border:none; border-radius:5px; margin:2; background: #11d99d; color:white; font-family:fantasy ; " value="수정" />
      <input type="reset"  style="border:none; border-radius:5px; background: #ea4335; color:white; font-family:fantasy ; " value="취소" 
      onclick="$('#mem_pwd').focus();" />
      <input type="button" style="border:none; border-radius:5px; background: #f0bc11; color:white; font-family:fantasy ; " value="회원목록"
