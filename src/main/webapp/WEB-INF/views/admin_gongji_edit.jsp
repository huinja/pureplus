...
<body>
					...
					<div class="tab-pane active" id="home">
						<div class="table-responsive">
							<table class="table table-hover">
								...
								<div id="aMain_cont">
    <div id="aBw_wrap">
     <h2 class="aBw_title" style="color:#379bff;" align="center">관리자 공지 수정</h2>
   ...
   <div id="aBw_menu">
    ...
    <input type="button"  style="border:none; border-radius:5px; background: #f0bc11; color:white; font-family:fantasy ; "value="목록"
